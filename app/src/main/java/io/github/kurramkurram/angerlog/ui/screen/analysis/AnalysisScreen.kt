...
@Composable
fun AnalysisScreen(modifier: Modifier = Modifier, viewModel: AnalysisViewModel = koinViewModel()) {
    Column(
        modifier = modifier
            .fillMaxSize()
            .padding(top = 20.dp),
...
@Composable
fun AnalysisScreenLockedCard(modifier: Modifier = Modifier, message: String) {
    Box(
        modifier = modifier
            .padding(10.dp)
            .background(
