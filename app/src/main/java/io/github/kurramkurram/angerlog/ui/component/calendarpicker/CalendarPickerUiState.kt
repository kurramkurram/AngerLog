...
class CalendarPickerUiState(
    ...
    fun selectYear(year: Int): CalendarPickerUiState =
        CalendarPickerUiState(now, yearDropDown, monthDropDown, yearMonth.withYear(year))

    fun selectMonth(month: Int): CalendarPickerUiState =
